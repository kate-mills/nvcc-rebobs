const commonQuestions = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        text: `Team dues are $250 for the season. NICA registration is done through PitZone for $60, with membership being $40. Races are $55 per race. Races are optional but highly recommended. Team dues cover one team jersey and some (camping fees, race food, coaching fees, scholarships), etc.`,
      },
  ...
  },
  {
    title: 'Coaches',
    items: [
      { question: `Are Rebob coaches trained?`, text: `Yes. All coaches undergo annual background checks, concussion, safety, risk management, and biannual athlete abuse awareness training. Level 2 coaches and above must be current in CPR and First Aid and have completed on-the-bike and classroom mountain bike skills training.`, },
    ]
  },
